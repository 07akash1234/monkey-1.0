...
function setup() {
  ...
  monkey=createSprite(80-50,315-50,20,20);
  monkey.addAnimation("moving",monkey_running);
  monkey.scale=0.1;

  ground=createSprite(400-50,350-50,900,10);
  ground.velocityX=-4;
  
  
  invisibleGround=createSprite(400-50,350-50,900,10); 
